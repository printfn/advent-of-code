...
rules[8] = [[42], [42, 8]];
let fortytwo = gen(rules[42]);

rules[11] = [[42, 31], [42, 11, 31]];
let thirtyone = gen(rules[31]);
let eleven = `(?:${fortytwo})(?:${thirtyone})`;
for (let i = 0; i < 3; ++i) {
    eleven += `|(?:${fortytwo})(?:${eleven})(?:${thirtyone})`;
}
rules[11] = eleven;
r = '^((' + fortytwo + ')+)(' + rules[11] + ')$';
